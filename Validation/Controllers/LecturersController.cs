...
namespace Validation.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EmailAddress")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EmailAddress")] Lecturer lecturer)
        {
            if (id != lecturer.Id)
            {
                return NotFound();
